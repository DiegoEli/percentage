...
namespace percentage_Windows
{
    class TrayIcon
    {
        ...
        private Bitmap GetTextBitmap(String text, Font font, Color fontColor)
        {
            ...
            //Bitmap bitmap = new Bitmap((int)imageSize.Width -100, (int)imageSize.Height);
            using (Graphics graphics = Graphics.FromImage(bitmap))
            {
                ...
                using (Brush brush = new SolidBrush(fontColor))
                {
                    ...
                    //graphics.DrawString(text, font, brush, -30, 0);
            ...
            using (Bitmap bitmap = new Bitmap(GetTextBitmap(bitmapText, new Font(font, fontSize), bitmapColor)))
            {
                ...
                try
                {
                    using (Icon icon = Icon.FromHandle(intPtr))
                    {
                        ...
                        String toolTipText = percentage + "%" + (isCharging ? " Charging AC" : " Not charging");
